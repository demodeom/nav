  ...
  <div class="modal" :class="className" id="bookmark-modal">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="bookmark-modal-title">编辑书签</h3>
      ...
      <form id="bookmark-form">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <select
              class="form-input"
              v-model="props.editModel.categoryKey"
            ...
            >
              ...
              <option v-for="category in props.categoryModelData"
                      :value="category.key"
                      :selected="category.key === props.editModel.categoryKey"
              >
                {{ category.name }}
              </option>
            </select>
        ...
        <div class="form-group">
          ...
          <input
            ...
            v-model="props.editModel.desc"
            required
          />
        </div>
        <span @click="emit('updateData', props.editModel)" class="submit-btn"
