    ...
    for i in config_dic['types']:
        ...
        for u in i['urls']:
            ...
            if u.get("img_src") and os.path.exists(u.get("img_src")):
                t = t.replace("{{ITEM_IMG_SRC}}", "https://blog.image.codedemo.vip/navigation/" + u.get("img_src").strip("./"))
            else:
                t = t.replace("{{ITEM_IMG_SRC}}", "https://blog.image.codedemo.vip/navigation/" + "img/default.png")
